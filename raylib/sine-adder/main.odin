...
main :: proc() {
    ...
    for !rl.WindowShouldClose() {
        ...
        for a: f32 = 0; a < WIDTH; a += 1 {
            y1 := curve1.amp * math.sin(curve1.freq*a*rl.DEG2RAD+curve1.phase)
            y2 := curve2.amp * math.sin(curve2.freq*a*rl.DEG2RAD+curve2.phase)
            y3 := curve3.amp * math.sin(curve3.freq*a*rl.DEG2RAD+curve3.phase)
            yt := y1 + y2 + y3
